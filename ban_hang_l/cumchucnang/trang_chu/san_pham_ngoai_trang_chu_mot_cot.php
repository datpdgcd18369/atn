...
<?php 
	...
	{
		$chieu_rong_o="333px";
		$chieu_rong_anh="200px";
		$style_tsp="style='margin-top:19px;margin-bottom:12px;' ";
	}
	if($ssp_td==4)
	{
		$chieu_rong_o="245px";
		$chieu_rong_anh="165px";
		$style_tsp="";
	}
	
	if($su_dung_chieu_rong_anh=="co")
	{
		$chieu_rong_anh=$chieu_rong_1;
	}
	
	echo "<center>";
		echo "<div class='tdg___ggg_bc2' style='width:990px' >";
			echo "<a href='#'>";
				echo "Sản phẩm";
			echo "</a>";
		echo "</div>";
		echo "<div class='ndg___ggg_bc2' id='fix_height_div__js' style='width:990px' >";
			echo "<table border='0' width='990px' style='font-size:14px'>";
