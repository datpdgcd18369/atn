...
<?php 
	...
	$chieu_rong_cot="770px";
	$colspan_2=" colspan='2' ";
	
	if($bo_cuc_web=="mot_cot" and ( $thamso=="" or $thamso=="xuat_sp" ) )
	{
		$chieu_rong_cot="990px";
		$colspan_2="";
	}
	...
	//echo '<link rel="stylesheet" type="text/css" href="giao_dien/cam/chung.css" > ';
	...
	<center>
		<div style="width:990px;text-align:left" id="khung_lon" >
			<table width="990px" border="0">
				...
				<tr>
					<td <?php echo $colspan_2; ?> class="o_menu_ngang" >
						<?php 
				...
				<tr>
					<td width="<?php echo $chieu_rong_cot; ?>" valign="top">
						<?php 
					...
					<?php 
						//echo $bo_cuc_web;
						//echo $thamso
						if($bo_cuc_web=="cot_trai_cot_phai" or ( $bo_cuc_web=="mot_cot" and $thamso!="" and $thamso!="xuat_sp" ) )
						{
					?>
