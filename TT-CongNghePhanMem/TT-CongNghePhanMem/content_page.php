                ...
                while ($result=mysqli_fetch_assoc($query))
                    { ?>
                        ...
                        <div class="dienthoai">
                            ...
                            <?php } ?>
                            <a href="index.php?content=chitietsp&idsp=<?php echo $result['idsp'] ?>"><img  src="images/uploads/<?php echo $result['hinhanh'];?>"></a>
    ...
    // Tạo liên kết đến trang tiếp theo
                    ...
                    <div class="sanpham">
                            ...
                            while ($row=mysqli_fetch_assoc($result1))
                                { ?>
                                    ...
                                    <div class="dienthoai">
                                        ...
                                        <?php } ?>
                                        <h1><a href="index.php?content=chitietsp&idsp=<?php echo $row['idsp'] ?>"><img  src="images/uploads/<?php echo $row['hinhanh'];?>"></a></h1>
                        ...
                        <div class="sanpham">
                            ...
                            <div class="sanphamcon">
                                <?php
                                $sql1="select * from sanpham inner join danhmuc on sanpham.madm = danhmuc.madm where dequi=1 order by idsp  DESC limit 8 ";
                                $result1= mysqli_query($conn,$sql1);
                                ?>
                                <?php
                                while ($row=mysqli_fetch_assoc($result1))
