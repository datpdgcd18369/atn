	...
	<table align="center" border="0">
		...
		?>
                   ...
                   <td class="tensp_hienthi_sp">
                    ...
                    <td class="active_hienthi_sp"><a href="?admin=suadm&madm=<?php echo $bien['madm']?>" > <img src="img/edit.png" title="Sửa" /></a>
					<?php echo "<p onclick = 'checkdel({$bien['madm'] })' ><img src='img/delete.png' title='Xóa' class='delete'></p>" ?>
                   </td>
        <?php  
				}
			}
...
<script language="JavaScript">
    ...
    {
        var	madm=madm;
        var link="deletecategory.php?madm="+madm;
