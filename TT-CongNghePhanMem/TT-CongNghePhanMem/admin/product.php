...
<a href='?admin=addproduct' >Thêm sản phẩm</a><br>
	<p>Có tổng <font color=red><b><?php echo $dem ?></b></font> sản phẩm</p>
	<form action="admin.php?admin=producthandling" method="post">
		<div id="check">
			<p>
...
?>
            <tr class='noidung_hienthi_sp'>
                ...
                <td class="img_hienthi_sp">
                    <img src="../images/uploads/<?php echo $bien['hinhanh'] ?>"  width='60' height='60'><br>
                ...
                <td class="active_hienthi_sp">
                    <a href='admin.php?admin=editproduct&idsp=<?php echo $bien['idsp']  ?>'><img src="img/edit.png" title="Sửa"></a>
				</td>
            </tr>
<?php 
    }
...
?>
	...
	<?php
			...
			if($page > 1){  
			$prev = ($page - 1);  
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=viewproduct&page=$prev\"><button class='trang'>Trang trước</button></a>&nbsp;";  
			}  
			...
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=viewproduct&page=$i\"><button class='so'>$i</button></a>&nbsp;";  
			}  
			}  
			...
			if($page < $total_pages){  
			$next = ($page + 1);  
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=viewproduct&page=$next\"><button class='trang'>Trang sau</button></a>";  
			}  
			echo "</center>";  		
