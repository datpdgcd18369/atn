...
?>
<form action="updateproduct.php?idsp=<?php echo $idsp;?>" method="post" name="frm" onsubmit="" enctype="multipart/form-data">
	<table>
            ...
            <tr>
            	<td>Hình ảnh</td><td class="img_hienthi_sp"><img src="../images/uploads/<?=$row['hinhanh']?>" width="80" height="120"/><br /><br /><input type="file" name="hinhanh" /></td>
            </tr>
			<tr>
