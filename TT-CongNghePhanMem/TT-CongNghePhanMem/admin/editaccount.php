...
?>
<form action="update_account.php?idnd=<?php echo $idnd;?>" method="post" name="frm" onsubmit="return kiemtra()" enctype="multipart/form-data">
	<table>
			<tr class="tieude_themsp">
				<td colspan=2>Sửa Tài Khoản </td>
			</tr>
    		<tr>
            	<td>Tên Khách Hàng</td><td><input type="text" name="tennd" value="<?php echo $row['tennd'] ?>"/></td>
            </tr>
			<tr>
            ...
            <tr>
                <td colspan=2 class="input"> <input type="submit" name="update" value="Xong" />
                <input type="reset" name="" value="Huỷ chỉnh sửa" /></td>
            </tr>
        </table> 
